...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter {
    ...
    private OnItemClickNetErrorListener onkNetErrorCallBack;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            case VIEW_TYPE_FOOTER:
                ...
                fvh.tv_footer.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                       //用于网络底部加载失败，点击从新加载
                        onkNetErrorCallBack.onItemClickNetError();
                    }
                });
                fvh.tv_footer.setClickable(false);
                fvh.itemView.setVisibility(View.VISIBLE);
                switch (mState) {
                    case STATE_INVALID_NETWORK:
                        fvh.tv_footer.setClickable(true);
     ...
     * @param listener
     */
    public final void setOnNetErrorCallBack(OnItemClickNetErrorListener listener) {
        onkNetErrorCallBack = listener;
    }
    ...
    public interface OnItemClickNetErrorListener {
        void onItemClickNetError();
    }
